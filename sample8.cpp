          ...
          if(pointThisTurn[myId] == 5){
            ...
            if(originalPoint >= 5){
              if(highPointCount <= 2){
                ...
                return (hiddenCount <= 1)? 1.0 : -1000.0;
              }
              // 低ポイント
            }else{
              return BAN;
            ...
            if(originalPoint >= 5){
              ...
              if(highPointCount >= 3){
                ...
                if(originalPoint == 4){
                  ...
                  return (hiddenCount == 0)? -1.0 : -160.0;
                }
              }
            }
            // 2pt以上割り振っている
          ...
          if(pointThisTurn[myId] >= 3){
            ...
            if(originalPoint >= 5){
              ...
              if(originalPoint == 4){
                ...
                return (hiddenCount == 0)? -4.0 : -320.0;
              }
            }
            // 2pt割り振る
          }else if(pointThisTurn[myId] == 2){
    ...
    double fuzzyScoreLast(int diff){
      ...
      if(diff >= 6){
        ...
        if(pointThisTurn[myId] >= 4){
          ...
          if(originalPoint >= 5){
            if(originalPoint == 6){
              return (hiddenCount <= 1)? 5.0 : -1.5 * hiddenCount;
            }else{
              return (hiddenCount <= 1)? 10.0 : -1.0 * hiddenCount;
            }
            // 低スコア
          }else{
          ...
          if(originalPoint >= 5){
            if(highPointCount >= 3){
              if(hiddenCount == 0){
                ...
                return (hiddenCount <= 1)? 1.0 : -5.0 * hiddenCount;
              }
            }else{
              if(hiddenCount == 0){
                return 5.0;
          ...
          if(pointThisTurn[myId] == 5){
            if(originalPoint >= 5){
              if(hiddenCount >= 4){
                ...
                return (hiddenCount <= 1)? 1.0 : -100.0 * hiddenCount;
              }
            }else{
              return BAN;
            }
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                if(hiddenCount == 0){
                  ...
                  return (hiddenCount == 1)? 2.0 : 50.0 * hiddenCount;
                }
              }else{
                if(hiddenCount == 0){
                  return 2.0;
                }else{
                  return (hiddenCount == 1)? 30.0 : 100.0 * hiddenCount;
                }
              }
            // low point
            }else{
