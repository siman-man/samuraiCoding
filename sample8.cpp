      ...
      if(diff >= 5){
        ...
        // 2T FSD5T2
          ...
          if(originalPoint >= 5){
            ...
            if(pointThisTurn[myId] >= 4){
              if(highPointCount >= 3){
                return (diff >= 6)? BAN : 1.0;
              }else{
                return (diff >= 6)? BAN : 2.0;
              }
            // 2pt以上割り振っている
            }else if(pointThisTurn[myId] >= 2){
              if(highPointCount >= 3){
          ...
          // 1pt以上割り振る
            ...
            // 低ポイント
              ...
              if(originalPoint == 4){
                ...
                return (hiddenCount <= 2)? 40.0 : 150.0;
              }
            }
          // 0pt FND5T7
          }else{
          ...
          // 1pt以上割り当て FNLD4
            ...
            // low point
              ...
              if(originalPoint == 4){
                ...
                return (hiddenCount <= 1)? 15.0 : 200.0;
              }
            }
          // 0pt FNLD4T5
          }else{
