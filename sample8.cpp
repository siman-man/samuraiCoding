       ...
       */
        ...
        // 8 turn FSD3T8
          ...
          if(pointThisTurn[myId] == 4){
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                return (hiddenCount <= 2)? -3.0 : 0.5;
              }else{
                return (hiddenCount <= 2)? -5.0 : 0.5;
              }
              // low point
            }else{
              if(highPointCount >= 3){
       ...
       */
        ...
        // 1ptも割り振っていない FSLD2
          ...
          if(originalPoint >= 5){
            ...
            if(turn == 5){
              return (hiddenCount == 0 && lastDiff >= 3)? -5.0 : -10.0 * hiddenCount;
            }else{
              return (hiddenCount == 0 && lastDiff >= 3)? 1.0 : -2.0 * hiddenCount;
            }
            // 低ポイント
          }else{
            if(highPointCount >= 3){
