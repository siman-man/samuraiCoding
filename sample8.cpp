...
class Lang{
  public:
     ...
     * 低いほど悪い
     */
    double fuzzyScore(int diff, int lastDiff){
      ...
      if(diff >= 5){
        ...
        if(turn == 4){
          ...
          if(pointThisTurn[myId] == 4){
            ...
            // low point
              ...
              if(originalPoint == 4 && diff <= 6){
                if(highPointCount <= 2){
                  return (hiddenCount <= 1)? -50.0 : -100.0;
                }else{
          ...
          // 2pt以上割り振った場合 FSD5T4
            ...
            if(originalPoint >= 5){
              if(hiddenCount >= 4){
                ...
                return (hiddenCount <= 1 && diff <= 7)? 1.5 : -2.0;
              }
              // 低スコア
            }else{
              if(highPointCount >= 3){
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                if(hiddenCount == 0){
                  ...
                  return (hiddenCount <= 1)? 5.0 : 0.0;
                }
              }else{
                if(hiddenCount == 0){
                  return 5.0;
                }else{
                  return (hiddenCount <= 1)? 2.5 : 0.0;
                }
              }
            // 低スコア
            }else{
        ...
        // 7ターン目 FSD5T7
          ...
          if(pointThisTurn[myId] >= 4){
            ...
            if(originalPoint >= 5){
              ...
              if(playerRank[myId] != 1){
                ...
                // 高いポイントが多い
                if(highPointCount >= 4){
                  return (hiddenCount <= 1 && diff <= 6)? -50.0 : -400.0;
                }else{
                  return (hiddenCount <= 1 && diff <= 6)? -25.0 : -200.0;
                }
              }
            // low point
            }else{
              if(originalPoint == 4){
                if(highPointCount >= 3){
                  ...
                  return (hiddenCount == 0 && diff <= 5)? -150.0 : -500.0;
                }
              }else{
                return BAN;
              }
          ...
          // 3pt以上振っている FSD5T7
            ...
            if(originalPoint >= 5){
              ...
              if(playerRank[myId] != 1){
                ...
                // 高いポイントが多い
                if(highPointCount >= 4){
                  return (hiddenCount <= 1 && diff <= 6)? -200.0 : -400.0;
                }else{
                  return (hiddenCount <= 1 && diff <= 6)? -100.0 : -200.0;
                }
              }
            // low point
            }else{
              if(originalPoint == 4){
                if(highPointCount >= 3){
                  ...
                  return (hiddenCount == 0 && diff <= 5)? -200.0 : BAN;
                }
              }else{
                return BAN;
              }
          ...
          // 2pt割り振る
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                return (hiddenCount <= 1 && diff <= 6)? 1.0 : -50.0;
              }else{
                return (hiddenCount <= 1 && diff <= 6)? 1.5 : -30.0;
              }
              // 低ポイント
            }else{
              if(originalPoint == 4){
          ...
          // 1pt以上振っている FSD5T7
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                return (hiddenCount <= 1 && diff <= 6)? 1.0 : -20.0;
              }else{
                return (hiddenCount <= 1 && diff <= 6)? 1.5 : -10.0;
              }
              // 低ポイント
            }else{
              if(originalPoint == 4){
        ...
        // 8T FSD5T8
          ...
          if(originalPoint >= 5){
            // 4pt割り振っている
            if(pointThisTurn[myId] == 4){
              return (hiddenCount <= 1 || diff >= 7)? BIGBAN : 1.5;
              // 2pt割り振っている
            }else if(pointThisTurn[myId] == 2){
              return (hiddenCount <= 1 || diff >= 7)? BIGBAN : 1.5;
            // 1ptも割り振っていない
              ...
              if(originalPoint >= 5){
                if(highPointCount >= 3){
                  if(hiddenCount == 0){
                    ...
                    return (hiddenCount <= 1)? 5.0 * diff : 1.0;
                  }
                }else{
                  if(hiddenCount == 0){
                    return 5 * diff;
        ...
        // 6 turn FSD5T6
          ...
          if(originalPoint >= 5){
            ...
            if(pointThisTurn[myId] == 4){
              if(highPointCount >= 3){
                return (diff <= 6)? 0.0 : -2.0;
              }else{
                return (diff <= 6)? 0.5 : -1.0;
              }
            // 2pt以上割り振っている
            }else if(pointThisTurn[myId] >= 2){
              // high point
              if(originalPoint >= 5){
                if(highPointCount >= 3){
                  ...
                  return (diff <= 6)? 0.2 : -1.0;
                }
              // low point
              }else{
                if(highPointCount >= 3){
                  return (diff <= 6)? -2.0 : -20.0;
                }else{
                  return (diff <= 6)? -1.0 : -10.0;
                }
              }
            // 1ptも割り振っていない
            }else{
       ...
       */
        ...
        if(turn == 3){
          ...
          if(pointThisTurn[myId] == 5){
            ...
            if(originalPoint >= 5){
              ...
              if(originalPoint == 4){
                if(highPointCount >= 3){
                  return (hiddenCount == 0)? -200.0 : -20.0;
                }else{
                  return (hiddenCount == 0)? -100.0 : -10.0;
                }
              }else{
                return BAN;
              }
        ...
        // 7T FSD4T7
          ...
          if(pointThisTurn[myId] == 5){
            ...
            if(originalPoint >= 5){
              if(hiddenCount >= 4){
                ...
                if(originalPoint == 6){
                  return (hiddenCount <= 1)? -0.5 : -300.0;
                }else{
                  return (hiddenCount <= 1)? -1.0 : -400.0;
                }
              }
              // 低スコア
            }else{
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                return (hiddenCount <= 1)? -1.0 : -150.0;
              }else{
                return (hiddenCount <= 1)? -0.5 : -100.0;
              }
              // 低スコア
            }else{
              return BAN;
          ...
          // 3pt割り振る FSD4T7
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                return (hiddenCount <= 1)? -1.0 : -50.0;
              }else{
                return (hiddenCount <= 1)? 0.0 : -25.0;
              }
            // 低スコア
            }else{
              if(hiddenCount == 0){
                ...
                if(originalPoint == 4){
                  ...
                  return (hiddenCount <= 1)? -2.0 : -150.0;
                }
              }
            }
          // 1pt以上割り振る FSD4T7
            ...
            // 高スコア
            if(originalPoint >= 5){
              return (hiddenCount <= 2)? -1.0 : -50.0;
              // 低スコア
            }else{
              if(hiddenCount == 0){
                return -100.0;
              }else{
                return (hiddenCount <= 2)? -1.0 : -100.0;
              }
            }
          // 1ptも割り振らない FSD4T7
          }else{
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                if(hiddenCount == 0){
                  ...
                  return (hiddenCount == 1)? 0.5 : -3.0;
                }
              }else{
                if(hiddenCount == 0){
                  return 1.0;
                }else{
                  return (hiddenCount == 1)? 0.0 : -4.0;
                }
              }
            // low point
            }else{
        ...
        // FSD4T8
          ...
          // 2pt割り振っている FSD4T8
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                return (hiddenCount <= 1)? 1.0 : -15.5;
              }else{
                return (hiddenCount <= 1)? 0.0 : -10.5;
              }
            // low point
            }else{
              if(hiddenCount == 0){
       ...
       */
        ...
        if(turn == 3){
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                ...
                if(hiddenCount >= 4){
                  ...
                  return (hiddenCount == 0)? 1.5 : -0.5;
                }
              }
            // 低ポイント
            }else{
              if(highPointCount >= 3){
                if(hiddenCount >= 3) return BAN;

                if(originalPoint == 4){
                  return (hiddenCount <= 1)? 1.0 : 0.0;
                }else{
                  return (hiddenCount <= 1)? 0.0 : -2.0;
                }
              }else{
                if(hiddenCount >= 3) return BAN;
          ...
          // 1pt割り振る FSD3T3
            ...
            // 高スコア
            if(originalPoint >= 5){
              if(hiddenCount >= 4) return BAN;

              if(highPointCount >= 3){
                return (hiddenCount == 0)? 1.0 : -10.0;
              }else{
                return (hiddenCount == 0)? 1.5 : -10.0;
              }
            }else{
              if(hiddenCount >= 4) return BAN;
          ...
          // 0pt FSD3T3
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                return (hiddenCount == 0)? -1.0 : -10.0 * hiddenCount;
              }else{
                return (hiddenCount == 0)? -1.5 : -15.0 * hiddenCount;
              }
            // low point
            }else{
              if(originalPoint == 4){
                return (hiddenCount <= 1)? 0.5 : 0.5;
              }else{
                return (hiddenCount <= 1)? 1.0 : 0.5;
              }
            }
        ...
        // 7T FSD3T7
          ...
          if(pointThisTurn[myId] == 5){
            ...
            if(originalPoint >= 5){
              if(highPointCount <= 2){
                ...
                return (hiddenCount <= 1)? 1.0 : -1000.0 * hiddenCount;
              }
              // 低ポイント
            }else{
              return BAN;
            ...
            // 高ポイント
            if(originalPoint >= 5){
              return (hiddenCount <= 1)? 2.0 : -200.0 * hiddenCount;
              // 低ポイント
            }else{
              return BAN;
            }
          ...
          // 2pt以上割り振る
            ...
            if(originalPoint >= 5){
              ...
              if(originalPoint == 4){
                return (hiddenCount == 0)? 1.0 : -0.5 * hiddenCount;
              }else{
                return (hiddenCount == 0)? 1.0 : -1.5 * hiddenCount;
              }
            }
          // 1pt割り振る FSD3T7
          }else if(pointThisTurn[myId] == 1){
            // 高スコア
            if(originalPoint >= 5){
              return (hiddenCount <= 1)? 1.0 : -2.0 * hiddenCount;
            }else{
              return (hiddenCount <= 1)? 1.0 : 0.5 * hiddenCount;
            }
          // 0pt
          }else{
            // 高スコア
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                return (hiddenCount == 0)? -2.0 : -10.0 * hiddenCount;
              }else{
                return (hiddenCount == 0)? -5.0 : -20.0 * hiddenCount;
              }
            // low point
            }else{
              if(originalPoint == 4){
                return (hiddenCount == 0)? 4.0 : 0.0;
              }else{
          ...
          if(pointThisTurn[myId] == 4){
            ...
            if(originalPoint >= 5){
              return (hiddenCount <= 1)? -5.0 : -3.0;
            }else{
              if(originalPoint == 4){
                return (hiddenCount <= 1)? 0.5 : 0.9;
              }else{
        ...
        // 8 turn FSD3T8
          ...
          // 何も降っていない
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                return (hiddenCount == 0)? 1.0 : -2.0 * hiddenCount;
              }else{
                return (hiddenCount == 0)? 0.0 : -3.0 * hiddenCount;
              }
              // low point
            }else{
              if(highPointCount >= 3){
        ...
        if(turn == 3){
          ...
          if(pointThisTurn[myId] >= 4){
            ...
            if(originalPoint >= 5){
              if(hiddenCount >= 4){
                ...
                if(sumPoint >= 6 && playerRank[myId] != 1){
                  if(highPointCount >= 3){
                    return (hiddenCount == 0)? -10.0 : -200.0 * hiddenCount;
                  }else{
                    return (hiddenCount == 0)? -5.0 : -100.0 * hiddenCount;
                  }
                }else{
                  return (hiddenCount == 0)? -5.0 : -20.0 * hiddenCount;
                }
              ...
              if(highPointCount >= 3){
                ...
                if(originalPoint == 4){
                  return (hiddenCount == 0)? -4.0 : -800.0 * hiddenCount;
                }else{
                  return BAN;
                }
              }
            ...
            if(originalPoint >= 5){
              ...
              if(highPointCount >= 3){
                if(originalPoint == 4){
                  return (hiddenCount == 0)? -1.0 : -40.0 * hiddenCount;
                }else{
                  return BAN;
                }
              }else{
                if(originalPoint == 4){
                  return (hiddenCount == 0)? 0.0 : -80.0 * hiddenCount;
                }else{
                  return (hiddenCount == 0)? -10.0 : -160.0 * hiddenCount;
                }
              }
            }
            // 2pt以上割り振っている
            ...
            if(originalPoint >= 5){
              if(hiddenCount >= 4){
                ...
                if(sumPoint >= 6 && playerRank[myId] != 1){
                  return (hiddenCount == 0)? 1.0 : -20.0 * hiddenCount;
                }else{
                  return (hiddenCount == 0)? 2.0 : -10.0 * hiddenCount;
                }
              }
            ...
            // 高スコア
            if(originalPoint >= 5){
              if(hiddenCount >= 5) return 0.0;

              if(highPointCount >= 3){
                return (hiddenCount <= 1)? -10.0 : -20.0 * hiddenCount;
              }else{
                return (hiddenCount <= 1)? -10.0 : -20.0 * hiddenCount;
              }
              // 低スコア
        ...
        // 4 turn FSD2T4
          ...
          // 2ptポイントを振っている FSD2T4
            ...
            if(originalPoint >= 5){
              ...
              if(originalPoint == 4){
                if(highPointCount >= 3){
                  return (hiddenCount == 0)? 0.2 : -20.0;
                }else{
                  return (hiddenCount == 0)? 0.5 : -10.0;
                }
              }else{
                if(highPointCount >= 3){
                  return (hiddenCount == 0)? -0.5 : -100.0;
                }else{
       ...
       */
          ...
          // 2pt以上割り振る
            ...
            if(originalPoint >= 5){
              ...
              if(sumPoint == 0){
                ...
                if(highPointCount <= 2){
                  if(originalPoint == 4){
                    return (sumPoint <= 2)? -1.0 : -100.0;
                  }else{
                    return (sumPoint <= 2)? -2.0 : -150.0;
                  }
                }else{
                  if(originalPoint == 4){
                    return (sumPoint <= 1)? -3.0 : -100.0;
                  }else{
                    return (sumPoint <= 1)? -10.0 : -200.0;
                  }
                }
              }
            }
        ...
        // 4 turn FSD1T4
          ...
          // 2つのポイントを割り振った場合
            ...
            if(originalPoint >= 5){
              if(hiddenCount == 0){
                ...
                if(highPointCount >= 3){
                  return (hiddenCount <= 1)? 2.0 : -20.0 * hiddenCount;
                }else{
                  return (hiddenCount <= 1)? 1.0 : -10.0 * hiddenCount;
                }
              }
              // low score
            }else{
          ...
          // 何もポイントを振らない FSD1T4
            ...
            // 高スコア
            if(originalPoint >= 5){
              if(hiddenCount >= 4) return 1.0;

              return (hiddenCount <= 1 && lastDiff >= 3)? -10.0 : -20.0;
              // 低スコア
            }else{
        ...
        // 3 turn FSD1T3
          ...
          // 0pt FSD1T3
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                if(hiddenCount >= 4) return 0.0;

                return (hiddenCount == 0 || lastDiff <= 2)? -5.0 : -1.0;
              }else{
                return (hiddenCount == 0 || lastDiff <= 2)? -10.0 : -1.0;
              }
            // low point
            }else{
              if(hiddenCount >= 3) return 1.0;
        ...
        // 7T FSD1T7
          ...
          // 2pt割り振る FSD1T7
            ...
            // high point
            if(originalPoint >= 5){
              if(highPointCount >= 3) return BAN;
          ...
          // 0pt FSD1T7
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                return (hiddenCount <= 1 || lastDiff <= 2)? -5.0 : -2.0;
              }else{
                return (hiddenCount <= 1 || lastDiff <= 2)? -10.0 : -2.0;
              }
            // low point
            }else{
              if(hiddenCount >= 3) return 0.0;

              if(originalPoint == 4){
                return (hiddenCount == 0)? 0.5 : -1.0 * hiddenCount;
              }else{
                return (hiddenCount == 0)? 1.0 : -0.5 * hiddenCount;
              }
            }
        ...
        // 8T FSD1T8
          ...
          // 2pt振っている FSD1T8
            ...
            if(originalPoint >= 5){
              ...
              if(highPointCount >= 3){
                if(originalPoint == 4){
                  return (hiddenCount == 0)? 0.1 : -60.0 * hiddenCount;
                }else{
                  return (hiddenCount == 0)? 0.0 : -120.0 * hiddenCount;
                }
              }else{
                if(originalPoint == 4){
                  return (hiddenCount == 0)? 0.1 : -40.0;
                }else{
                  return (hiddenCount == 0)? 0.0 : -80.0;
                }
              }
          ...
          if(pointThisTurn[myId] >= 3){
            ...
            if(originalPoint >= 5){
              if(sumPoint - point[myId] >= 4){
                ...
                return (hiddenCount == 0)? -1.0 : -80.0 * hiddenCount;
              }
              // 低ポイント
            }else{
              if(originalPoint == 4){
                return (hiddenCount == 0)? -2.0 : -160.0 * hiddenCount;
              }else{
                return (hiddenCount == 0)? -4.0 : -320.0 * hiddenCount;
              }
            }
            // 2pt割り振る
          }else if(pointThisTurn[myId] == 2){
            ...
            if(originalPoint >= 5){
              if(hiddenCount >= 3){
                return (hiddenCount == 0)? -1.0 : -250.0 * hiddenCount;
              }else{
            ...
            if(originalPoint >= 5){
              ...
              return (hiddenCount == 0)? -2.0 : -80.0 * hiddenCount;
            }
            // 何も割り振らない
          }else{
            // 高ポイント
            if(originalPoint >= 5){
              return (hiddenCount <= 1)? -3.0 : -1.0;
              // 低ポイント
            }else{
              return (hiddenCount <= 1)? -1.0 : 0.0;
            }
          ...
          if(pointThisTurn[myId] == 5){
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 4){
                ...
                return (hiddenCount == 0)? -600.0 : BAN;
              }
              // 低ポイント
            }else{
              return BAN;
          ...
          // 4pt以上割り振る
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                ...
                return (hiddenCount == 0)? -5.0 : -150.0 * hiddenCount;
              }
              // 低ポイント
            }else{
              if(highPointCount >= 3){
                if(originalPoint == 4){
                  return (hiddenCount == 0)? -50.0 : -800.0 * hiddenCount;
                }else{
                  return (hiddenCount == 0)? -100.0 : BAN;
                }
              }else{
                if(originalPoint == 4){
                  return (hiddenCount == 0)? -20.0 : -400.0 * hiddenCount;
                }else{
                  return (hiddenCount == 0)? -40.0 : -800.0 * hiddenCount;
                }
              }
            }
            // 2pt以上割り振る
            ...
            if(originalPoint >= 5){
              ...
              if(highPointCount >= 3){
                ...
                return (hiddenCount == 0)? -15.0 : -300.0 * hiddenCount;
              }
            }
            // 1pt以上割り振る
          }else if(pointThisTurn[myId] >= 1){
            ...
            if(originalPoint >= 5){
              ...
              if(highPointCount >= 3){
                if(originalPoint == 4){
                  return (hiddenCount == 0)? -5.0 : -60.0 * hiddenCount;
                }else{
                  return (hiddenCount == 0)? -10.0 : -120.0 * hiddenCount;
                }
              }else{
                if(originalPoint == 4){
                  return (hiddenCount == 0)? -2.0 : -40.0 * hiddenCount;
                }else{
                  return (hiddenCount == 0)? -4.0 : -80.0 * hiddenCount;
                }
              }
            }
            // 何も割り振らない
            ...
            // 高ポイント
            if(originalPoint >= 5){
              return (hiddenCount <= 1)? -2.0 : -2.0 * hiddenCount;
              // 低ポイント
            }else{
              return (hiddenCount <= 1)? -1.0 : 0.0;
            }
     ...
     * 低いほど悪い
     */
    double fuzzyScoreLast(int diff, int lastDiff){
      /*
       * 2位との差が6pt以上 FSLD6
       */
      if(diff >= 6){
        ...
        if(pointThisTurn[myId] >= 4){
          ...
          if(originalPoint >= 5){
            ...
            if(hiddenCount >= 5){
              ...
              if(highPointCount <= 2 && diff <= 7){
                return (hiddenCount <= 2)? BAN : -100.0;
              }else{
                return (hiddenCount <= 2)? BAN : -1000.0;
              }
            }
            // 低スコア
          }else{
          ...
          if(originalPoint >= 5){
            if(originalPoint == 6){
              return (hiddenCount <= 1 || diff >= 7)? 5.0 : -1.5 * hiddenCount;
            }else{
              return (hiddenCount <= 1 || diff >= 7)? 10.0 : -1.0 * hiddenCount;
            }
            // 低スコア
          }else{
            return (hiddenCount <= 1)? 50.0 : 1.0;
          }
        }
        /*
         * 2位との差が5pt FSLD5
            ...
            if(turn == 5){
              if(hiddenCount >= 4){
                ...
                if(originalPoint == 6){
                  ...
                  return (hiddenCount <= 1)? 0.5 : -200.0;
                }
              }
              // 最後のスコア計算
            }else{
              if(hiddenCount == 2){
                ...
                if(originalPoint == 6){
                  ...
                  return (hiddenCount <= 1)? 0.5 : -150.0;
                }
              }
            }
          // low point
            ...
            if(highPointCount >= 3){
              ...
              if(originalPoint == 4){
                return (hiddenCount == 0)? BAN : -500.0;
              }else{
                return BAN;
              }
            }
          ...
          if(originalPoint >= 5){
            ...
            if(turn == 5){
              if(hiddenCount >= 4){
                ...
                return (hiddenCount == 0)? -100.0 : -20.0;
              }
              // 最後のスコア計算
            }else{
          ...
          if(originalPoint >= 5){
            ...
            if(turn == 5){
              if(hiddenCount >= 4){
                ...
                return (hiddenCount <= 2)? -100.0 : -100.0;
              }
              // 最後のスコア計算
            }else{
              return (hiddenCount <= 2)? -10.0 : 1.0;
          ...
          if(originalPoint >= 5){
            if(highPointCount >= 3){
              if(hiddenCount == 0){
                ...
                return (hiddenCount <= 1)? 1.0 : -20.0 * hiddenCount;
              }
            }else{
              if(hiddenCount == 0){
                return 5.0;
              }else{
                return (hiddenCount <= 1)? 0.0 : -30.0 * hiddenCount;
              }
            }
          // low point
          }else{
       ...
       */
        ...
        // 4pt以上割り振っている
          ...
          if(originalPoint >= 5){
            if(hiddenCount >= 4){
              ...
              return (hiddenCount <= 1)? 2.0 : -100.0 * hiddenCount;
            }
            // 低スコア
          }else{
            if(highPointCount >= 3){
        ...
        // 3pt以上割り振っている
          ...
          if(originalPoint >= 5){
            if(hiddenCount >= 4){
              ...
              if(hiddenCount == 2){
                ...
                return (hiddenCount <= 1)? 2.0 : -10.0 * hiddenCount;
              }
            }
          // low point
          }else{
            if(highPointCount >= 3){
              if(originalPoint == 4){
                return (hiddenCount == 0)? -10.0 : -400.0 * hiddenCount;
              }else{
                return (hiddenCount == 0)? -50.0 : -800.0 * hiddenCount;
              }
            }else{
              if(originalPoint == 4){
                return (hiddenCount == 0)? -4.0 : -200.0 * hiddenCount;
              }else{
                return (hiddenCount == 0)? -10.0 : -400.0 * hiddenCount;
              }
            }
          ...
          if(originalPoint >= 5){
            if(hiddenCount >= 4){
              ...
              if(hiddenCount == 0){
                ...
                return (hiddenCount <= 1)? 0.5 : -5.0 * hiddenCount;
              }
            }
            // low point
          }else{
          ...
          // high point
          if(originalPoint >= 5){
            return (hiddenCount == 0)? 3.0 : -5.0 * hiddenCount;
          // low point
          }else{
          ...
          // 4pt以上割り振っている
            ...
            if(originalPoint >= 5){
              if(hiddenCount >= 4){
                ...
                if(highPointCount <= 3){
                  return (hiddenCount == 0)? 0.5 : -100.0 * hiddenCount;
                }else{
                  return (hiddenCount == 0)? 1.0 : -100.0 * hiddenCount;
                }
              }
              ...
              if(highPointCount >= 3){
                if(originalPoint == 4){
                  return (hiddenCount == 0)? -1.0 : -400.0 * hiddenCount;
                }else{
                  return BAN;
                }
              }else{
                if(originalPoint == 4){
                  return (hiddenCount == 0)? 0.0 : -300.0 * hiddenCount;
                }else{
                  return (hiddenCount == 0)? -1.5 : -600.0 * hiddenCount;
                }
              }
            }
            // 2pt割り振る D3
            ...
            if(originalPoint >= 5){
              if(hiddenCount >= 4){
                ...
                return (hiddenCount <= 1)? 3.0 : -100.0 * hiddenCount;
              }
              // 低ポイント
            }else{
              if(highPointCount <= 2){
                if(originalPoint == 4){
                  return (hiddenCount == 0)? 0.0 : -200.0 * hiddenCount;
                }else{
                  return (hiddenCount == 0)? -1.0 : -300.0 * hiddenCount;
                }
              }else{
                if(originalPoint == 4){
                  return (hiddenCount == 0)? 0.0 : BAN;
            ...
            // 低ポイント
              ...
              if(highPointCount <= 2){
                return (hiddenCount <= 1)? 0.0 : -10.0 * hiddenCount;
              }else{
                if(originalPoint == 4){
                  return (hiddenCount == 0)? 0.5 : -1.0 * hiddenCount;
                }else{
                  return (hiddenCount == 0)? 0.0 : -2.0 * hiddenCount;
                }
              }
            }
          // 1ptも割り振っていない D3
        ...
        // 9T FSLD3T9
          ...
          if(pointThisTurn[myId] == 5){
            if(originalPoint >= 5){
              if(hiddenCount >= 4){
                ...
                return (hiddenCount <= 1)? 1.0 : -300.0 * hiddenCount;
              }
            }else{
              return BAN;
            }
          // 4pt割り振る FSLD3T9
            ...
            // low point
              ...
              if(originalPoint == 4){
                ...
                return (hiddenCount == 0)? -2.0 : -400.0 * hiddenCount;
              }
            }
          // 3pt以上割り振っている FSLD3T9
          }else if(pointThisTurn[myId] >= 3){
            // high point
            if(originalPoint >= 5){
              if(hiddenCount >= 4){
          ...
          // 2pt割り振る FSLD3T9
            ...
            if(originalPoint >= 5){
              ...
              if(highPointCount <= 2){
                if(originalPoint == 4){
                  return (hiddenCount == 0)? 0.0 : -10.0 * hiddenCount;
                }else{
                  return (hiddenCount == 0)? 0.0 : -10.0 * hiddenCount;
                }
              }else{
                if(originalPoint == 4){
                  return (hiddenCount == 0)? -10.0 : -100.0 * hiddenCount;
                }else{
                  return (hiddenCount == 0)? -20.0 : -100.0 * hiddenCount;
                }
              }
            }
          // 1pt以上割り振っている FSLD3T9
          }else if(pointThisTurn[myId] >= 1){
            // 高ポイント
            if(originalPoint >= 5){
              if(hiddenCount >= 4){
                ...
                return (hiddenCount == 0)? 0.3 : -50.0 * hiddenCount;
              }
            // 低ポイント
            }else{
              if(highPointCount <= 2){
                return (hiddenCount <= 1)? 0.0 : -1.0 * hiddenCount;
              }else{
                if(originalPoint == 4){
                  return (hiddenCount <= 1)? 0.0 : -1.0 * hiddenCount;
                }else{
                  return (hiddenCount <= 1)? -1.0 : -1.0 * hiddenCount;
                }
              }
            }
            // 1ptも割り振っていない
            ...
            if(originalPoint >= 5){
              if(turn == 5){
                ...
                if(hiddenCount == 0){
                  ...
                  return (hiddenCount == 1)? 0.0 : -2.0 * hiddenCount;
                }
              }
              // 低ポイント
            }else{
          ...
          if(originalPoint >= 5){
            ...
            if(highPointCount >= 3){
              if(originalPoint == 4){
                ...
                return (hiddenCount == 0)? 1.0 : -1.0 * hiddenCount;
              }
            }else{
              if(originalPoint == 4){
                return (hiddenCount == 0)? 1.0 : -1.0 * hiddenCount;
              }else{
                return (hiddenCount == 0)? 2.0 : -0.5 * hiddenCount;
              }
            }
          }
        // 1ptも割り振っていない FSLD2
        ...
        if(pointThisTurn[myId] >= 5){
          ...
          if(originalPoint >= 5){
            ...
            if(hiddenCount == 0){
              if(highPointCount <= 2){
                if(originalPoint == 4){
                  return (highPointCount == 0)? -500.0 : BAN;
                }else{
                  return BAN;
                }
              }else{
        ...
        // 1pt以上割り振っている FSLD1
          ...
          if(originalPoint >= 5){
            if(hiddenCount >= 4){
              ...
              return (hiddenCount == 0)? 0.0 : -100.0 * hiddenCount;
            }
            // 低ポイント
          }else{
            if(hiddenCount >= 4){
          ...
          if(originalPoint >= 5){
            ...
            if(originalPoint == 4){
              return (hiddenCount == 0)? 0.0 : 0.1;
            }else{
              return (hiddenCount == 0)? 0.5 : 0.1;
            }
          }
        }
      /*
        ...
        if(pointThisTurn[myId] >= 4){
          ...
          if(originalPoint >= 5){
            ...
            if(highPointCount <= 2){
              ...
              if(originalPoint == 4){
                return (hiddenCount == 0)? 0.0 : -20.0 * hiddenCount;
              }else{
                return (hiddenCount == 0)? -2.0 : -50.0 * hiddenCount;
              }
            }else{
              if(hiddenCount >= 3) return BAN;

              if(originalPoint == 4){
                return (hiddenCount == 0)? -1.0 : -50.0 * hiddenCount;
              }else{
                return (hiddenCount == 0)? -20.0 : -100.0 * hiddenCount;
              }
            }
          ...
          if(originalPoint >= 5){
            ...
            if(highPointCount <= 2){
              ...
              if(originalPoint == 4){
                return (hiddenCount == 0)? 0.5 : -10.0 * hiddenCount;
              }else{
                return (hiddenCount == 0)? 0.0 : -20.0 * hiddenCount;
              }
            }else{
              ...
              if(originalPoint == 4){
                return (hiddenCount == 0)? 0.3 : -20.0 * hiddenCount;
              }else{
                return (hiddenCount == 0)? 0.0 : -40.0 * hiddenCount;
              }
            }
          }
        // 1ptも割り振らない FSLD0
          ...
          if(originalPoint >= 5){
            ...
            if(originalPoint == 4){
              if(hiddenCount == 0){
                ...
                return (hiddenCount <= 1)? 0.5 : -1.0 * hiddenCount;
              }
            }else{
              return (hiddenCount <= 1)? 1.0 : -0.0;
            }
       ...
       */
        ...
        if(turn == 7){
          ...
          // 0pt
            ...
            // high point
            if(originalPoint >= 5){
              return (hiddenCount == 0)? 20.0 : -1.0;
              // low point
            }else{
              return (hiddenCount == 0)? 10.0 : -3.0;
            }
          }
        // 3 turn FWD2T3
        }else if(turn == 3){
        ...
        if(turn == 8){
          ...
          // 何も割り振らない
            ...
            if(originalPoint >= 5){
              if(originalPoint == 6){
                return (hiddenCount == 0)? 400.0 : 10.0;
              }else{
                return (hiddenCount == 0)? 300.0 : 10.0;
              }
            // low point
            }else{
              if(originalPoint == 4){
                return (hiddenCount == 0)? 200.0 : 10.0;
              }else{
                return (hiddenCount == 0)? 100.0 : 10.0;
              }
            }
        ...
        // 7 turn FWD0T7
          ...
          // 2pt割り振る
            ...
            if(originalPoint >= 5){
              ...
              return (hiddenCount == 0)? 40.0 : 400.0;
            }
          // 1pt以上割り振っている
          }else if(pointThisTurn[myId] >= 1){
            // high point
            if(originalPoint >= 5){
              ...
              if(highPointCount >= 3){
                return (hiddenCount == 0)? 30.0 : 300.0;
              }else{
                return (hiddenCount == 0)? 20.0 : 200.0;
              }
            }
        ...
        // 8 turn FWD0T8
          ...
          // 1ptも割り振らない
            ...
            if(originalPoint >= 5){
              ...
              return (hiddenCount == 0)? 30.0 : 30 - 10.0 * hiddenCount;
            }else{
              if(hiddenCount >= 3) return 0.0;
      ...
      if(diff >= 5){
        ...
        if(turn == 7){
          ...
          // 1pt以上割り振る
            ...
            // 高ポイント
            if(originalPoint >= 5){
              return (hiddenCount <= 2)? 10.0 : 50.0 * (hiddenCount-2);
            // 低ポイント
            }else{
              if(originalPoint == 4){
                return (hiddenCount <= 2)? 20.0 : 100.0 * (hiddenCount-2);
              }else{
                return (hiddenCount <= 2)? 40.0 : 150.0 * (hiddenCount-2);
              }
            }
          // 0pt FND5T7
          }else{
        ...
        // 8 turn FND5T8
          ...
          if(pointThisTurn[myId] == 4){
            ...
            if(originalPoint >= 5){
              if(diff >= 7){
                ...
                return (hiddenCount <= 1)? 5.0 : 50.0;
              }else{
                return (hiddenCount <= 1)? 3.0 : 30.0;
              }
            // 低スコア
            }else{
              if(originalPoint == 4){
          ...
          // 2pt割り振る
            ...
            if(originalPoint >= 5){
              if(topDiff >= 5){
                return (hiddenCount <= 2)? 100.0 : -BAN;
              }else{
          ...
          // 0pt FND5T8
            ...
            if(originalPoint >= 5){
              ...
              if(originalPoint == 4){
                ...
                return (hiddenCount <= 1)? -50.0 : 0.15;
              }
            }
          }
        // 6 turn FND5T6
        ...
        // 4 turn FND5T4
          ...
          // 0pt
            ...
            // 高スコア
            if(originalPoint >= 5){
              return (hiddenCount <= 1)? 1.0 : 4.0;
              // 低スコア
            }else{
              if(originalPoint == 4){
                return (hiddenCount <= 1)? 0.5 : 1.5;
              }else{
       ...
       */
        ...
        if(turn == 7){
          ...
          if(pointThisTurn[myId] >= 1){
            ...
            // 低スコア
              ...
              if(originalPoint == 4){
                return (hiddenCount <= 2)? 10.0 : 20.25;
              }else{
                return (hiddenCount <= 2)? 15.0 : 25.25;
              }
            }
          // 1ptも割り振らない FND4T7
          }else{
            ...
            if(originalPoint >= 5){
              ...
              if(highPointCount <= 2){
                if(originalPoint == 4){
                  ...
                  return (hiddenCount == 0)? 20.0 : 150.0;
                }
              }else{
                return (hiddenCount == 0)? 10.0 : 100.0;
              }
        ...
        // 3 turn FND4T3
          ...
          // 1pt以上割り振る
            ...
            // high point
            if(originalPoint >= 5){
              return (hiddenCount <= 1)? 0.0 : 3.25;
            // low point
            }else{
              return (hiddenCount <= 1)? 0.5 : 5.25;
            }
          // 0pt
          }else{
            // high point
       ...
       */
        ...
        if(turn == 3){
          ...
          // 何も割り振らない
            ...
            if(originalPoint >= 5){
              return (hiddenCount <= 1)? 2.0 : 0.35;
            }else{
              return (hiddenCount <= 1)? 1.0 : 0.35;
            }
          }
        // 7 turn FND3T7
        }else if(turn == 7){
          ...
          // 1pt以上割り振る
            ...
            // low point
              ...
              if(sumPoint - point[myId] >= 15){
                ...
                return (hiddenCount == 0)? 15.0 : 20.0;
              }
            }
          // 0p
          }else{
        ...
        if(turn == 7){
          ...
          if(pointThisTurn[myId] == 5){
            ...
            // 高ポイント
            if(originalPoint >= 5){
              return (hiddenCount == 0)? 50.0 : 400.0 * hiddenCount;
              // 低ポイント
            }else{
              if(originalPoint == 4){
                return (hiddenCount == 0)? 100.0 : 800.0 * hiddenCount;
              }else{
                return -BAN;
              }
            }
          // 2pt以上割り振っている FND2T7
            ...
            if(originalPoint >= 5){
              return (hiddenCount == 0)? 10.0 : 25.0 * hiddenCount;
            }else{
              if(highPointCount >= 3){
                return (hiddenCount == 0)? 20.0 : 100.0 * hiddenCount;
              }else{
                return (hiddenCount == 0)? 15.0 : 50.0 * hiddenCount;
              }
            }
          // 1pt割り振っている
          }else if(pointThisTurn[myId] >= 1){
            if(sumPoint - point[myId] >= 15){
              // 高ポイント
              if(originalPoint >= 5){
                return (hiddenCount == 0)? 20.0 : 50.0;
                // 低ポイント
              }else{
              ...
              if(originalPoint >= 5){
                ...
                return (hiddenCount == 0)? 20.0 : 40.0;
              }
            }
          // 0pt FND2T7
          }else{
            if(originalPoint >= 5){
              ...
              return (hiddenCount <= 1)? 20.0 : 200.0;
            }
          }
        // 3 turn FND2T3
        }else if(turn == 3){
        ...
        if(turn == 3){
          ...
          // 2pt以上割り振る
            ...
            // low point
              ...
              if(highPointCount >= 3){
                if(originalPoint == 4){
                  return (hiddenCount == 0)? 2.5 : 50.0;
                }else{
                  return (hiddenCount == 0)? 5.0 : 100.0;
                }
              }else{
                if(originalPoint == 4){
                  return (hiddenCount == 0)? 0.5 : 20.0;
                }else{
      ...
      if(diff >= 5){
        ...
        if(turn == 5){
          ...
          // 3pt以上割り振る
            ...
            // high point
            if(originalPoint >= 5){
              return (hiddenCount <= 1 && diff <= 6)? 50.0 : 100.0;
            // low point
            }else{
              return -BAN;
            }
          // 2pt割り振る
            ...
            // high point
            if(originalPoint >= 5){
              return (hiddenCount <= 1 && diff <= 6)? 25.0 : 100.0;
            // low point
            }else{
              return (hiddenCount <= 1 && diff <= 5)? 100.0 : 200.0;
            }
          // 1pt以上割り振る
          }else if(pointThisTurn[myId] >= 1){
            // high point
            if(originalPoint >= 5){
              return (hiddenCount <= 1 && diff <= 6)? 10.0 : 100.0;
            // low point
            }else{
              return (hiddenCount <= 1 && diff <= 5)? 100.0 : 200.0;
            }
          // 0pt
            ...
            if(originalPoint >= 5){
              if(hiddenCount == 0){
                ...
                return (hiddenCount <= 1)? 2.0 : 30.0;
              }
            }else{
              if(originalPoint == 4){
                return (hiddenCount <= 1)? 0.5 : 5.0;
              }else{
                return (hiddenCount <= 1)? 0.0 : 2.0;
              }
            }
       ...
       */
        ...
        if(turn == 5){
          ...
          // 3pt割り振り
            ...
            // 低ポイント
              ...
              if(hiddenCount >= 4 || topDiff >= 3){
                ...
                if(originalPoint == 4){
                  return (hiddenCount <= 1)? 100.0 : -BAN;
                }else{
                  return -BAN;
                }
              }
          ...
          // 2pt割り当て
            ...
            // high point
            if(originalPoint >= 5){
              return (hiddenCount == 0)? 0.0 : 50.0 * hiddenCount;
            // low point
            }else{
              if(originalPoint == 4){
                return (hiddenCount == 0)? -0.5 : 100.0 * hiddenCount;
              }else{
                return (hiddenCount == 0)? -1.0 : 150.0 * hiddenCount;
              }
            }
          // 1pt以上割り当て FNLD4
          }else if(pointThisTurn[myId] >= 1){
        ...
        // 9 turn
          ...
          // 1pt以上割り当て FNLD4
            ...
            // high point
            if(originalPoint >= 5){
              return (hiddenCount <= 1)? 5.0 : 100.0;
            // low point
            }else{
              return (hiddenCount <= 1)? 10.0 : 150.0;
            }
          // 0pt
          }else{
            // high point
        ...
        if(turn == 5){
          ...
          // 3pt以上割り振る FNLD3T5
            ...
            // 低ポイント
              ...
              if(originalPoint == 4){
                return (hiddenCount <= 1)? 15.0 : -BAN;
              }else{
                return (hiddenCount <= 1)? 20.0 : -BAN;
              }
            }
          // 2pt以上割り振る FNLD3
          }else if(pointThisTurn[myId] >= 2){
            ...
            // low point
              ...
              return (hiddenCount <= 1)? 5.0 : 400.0 * hiddenCount;
            }
            // 1pt以上割り振る
          }else if(pointThisTurn[myId] >= 1){
            // high point
            if(originalPoint >= 5){
              return (hiddenCount <= 1)? 5.0 : 100.0 * hiddenCount;
            // high point
            }else{
              return (hiddenCount <= 1)? 10.0 : 200.0 * hiddenCount;
            }
          // 0pt
          }else{
            // high point
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                if(hiddenCount == 0){
                  ...
                  return (hiddenCount == 1)? 20.0 : 50.0 * hiddenCount;
                }
              }else{
                if(hiddenCount == 0){
                  return 2.0;
                }else{
                  return (hiddenCount == 1)? 50.0 : 100.0 * hiddenCount;
                }
              }
            // low point
            }else{
        ...
        // turn 9 FNLD3T9
          ...
          // 2pt以上割り振る
            ...
            // low point
              ...
              return (hiddenCount <= 1)? 5.0 : 400.0;
            }
          // 1pt以上割り振る FNLD3T9
          }else if(pointThisTurn[myId] >= 1){
            // high point
            ...
            // low point
              ...
              if(originalPoint == 4){
                return (hiddenCount == 0)? 20.0 : 10.0 * hiddenCount;
              }else{
                return (hiddenCount == 0)? 25.0 : 15.0 * hiddenCount;
              }
            }
          // 0pt
          }else{
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                return (hiddenCount == 0)? 0.0 : 4.0 * hiddenCount;
              }else{
                return (hiddenCount == 0)? 0.0 : 10.0 * hiddenCount;
              }
            // low point
              ...
              if(hiddenCount >= 4){
                ...
                if(sumPoint >= 15){
                  ...
                  if(highPointCount <= 3){
                    ...
                    return (hiddenCount == 0)? 15.0 : 300.0;
                  }
                }
              }
            // 低スコア
          ...
          // 2pt以上割り振る FNLD2
            ...
            // 低スコア
              ...
              if(originalPoint == 4){
                ...
                if(highPointCount >= 3){
                  return (hiddenCount == 0)? 5.0 : 200.0 * hiddenCount;
                }else{
                  return (hiddenCount == 0)? 2.5 : 200.0 * hiddenCount;
                }
              }
            }
          // 1pt以上割り振る FNLD2
              ...
              if(hiddenCount >= 4){
                ...
                if(sumPoint >= 30){
                  ...
                  if(highPointCount <= 2){
                    ...
                    return (hiddenCount == 0)? 15.0 : 1000.0;
                  }
                }
              }
            // 低スコア
            ...
            // 低スコア
              ...
              if(highPointCount >= 3){
                if(originalPoint == 4){
                  ...
                  return (hiddenCount == 0)? 100.0 : 400.0;
                }
              }else{
                if(originalPoint == 4){
                  return (hiddenCount == 0)? 2.0 : 100.0;
          ...
          // 1pt以上割り振る FNLD2T9
            ...
            // 低スコア
              ...
              if(hiddenCount >= 4){
                ...
                if(originalPoint == 4){
                  return (hiddenCount <= 1)? 0.5 : 400.0;
                }else{
                  return (hiddenCount <= 1)? 1.0 : 800.0;
                }
              }
            }
          // 0pt FNLD2T9
            ...
            if(originalPoint >= 5){
              if(highPointCount >= 3){
                if(hiddenCount >= 4){
                  ...
                  return (hiddenCount == 0)? 5.0 : 25.0;
                }
              }else{
                if(hiddenCount >= 4){
                  return -BAN;
                }else{
                  return (hiddenCount == 0)? 10.0 : 20.0;
                }
              }
            // low point
            }else{
            ...
            // 低スコア
              ...
              if(highPointCount <= 2){
                if(originalPoint == 4){
                  ...
                  return (hiddenCount == 0)? 5.0 : 800.0;
                }
              }else{
                if(originalPoint == 4){
          ...
          // 何も割り振らない FNLD1
            ...
            if(originalPoint >= 5){
              ...
              if(highPointCount >= 3){
                ...
                return (hiddenCount == 0)? 15.0 : 30.0;
              }
            }else{
              if(hiddenCount >= 3) return 1.0;
        ...
        // 9 turn FNLD1T5
            ...
            // 低スコア
              ...
              if(highPointCount <= 2){
                if(originalPoint == 4){
                  ...
                  return (hiddenCount == 0)? 80.0 : 200.0;
                }
              }else{
                return -BAN;
              }
          ...
          // 2pt以上割り振る FNLD1T9
            ...
            if(originalPoint >= 5){
              if(hiddenCount >= 4){
                ...
                return (hiddenCount == 0)? 5.0 : 300.0;
              }
            // 低スコア
            }else{
              // 高スコアが少ない
          ...
          // 1pt割り振る FNLD1T9
            ...
            // 低スコア
              ...
              if(highPointCount <= 2){
                if(originalPoint == 4){
                  return (hiddenCount == 0)? 0.5 : 150.0;
                }else{
                  return (hiddenCount == 0)? 1.0 : 200.0;
                }
              }else{
                if(originalPoint == 4){
                  ...
                  return (hiddenCount == 0)? 40.0 : 1000.0;
                }
              }
            }
          // 何も割り振らない FNLD1T9
    ...
    double playerPoint(int id){
      ...
      if(worstPlayer == id){
        if(isLastDay()){
          ...
          // 0pt割り振る
            ...
            // low point
              ...
              if(highPointCount >= 3){
                if(originalPoint == 4){
                  return (hiddenCount == 0)? -40.0 : -20.0;
                }else{
        ...
        if(isLastDay()){
          return fuzzyScoreLast(bestDiff, normalDiff);
        }else{
          return fuzzyScore(bestDiff, normalDiff);
        }
      }else{
        if(isLastDay()){
  ...
  public:
    ...
    vector<int> weekSelect(){
      ...
      do {
        ...
        for(int i = 0; i < data.size(); i++){
          if(rockNumbers.find(data[i]) != rockNumbers.end()) flag = false;
        }

        //if(flag || !isLastDay()){
        if(true){
        //if(rockNumber == -1 || (data[0] != rockNumber && data[1] != rockNumber && data[2] != rockNumber && data[3] != rockNumber && data[4] != rockNumber)){
          addPoint(myId, data);
    ...
    vector<int> holidaySelect(){
      ...
      do {
        ...
        //if(flag || true){
        if(flag){
        //if(rockNumber == -1 || (data[0] != rockNumber && data[1] != rockNumber)){
    ...
    vector<int> firstSelect(){
      ...
      for(int i = 0; i < LANG_COUNT; i++){
        if(sl[langList[i].ranking-1] == -1){
          rockNumber = i;
          rockNumbers.insert(i);
          //fprintf(stderr,"direct rock number = %d\n", i);
        }
